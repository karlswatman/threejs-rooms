...
var container = document.querySelector("body"),
	...
	camera = new THREE.PerspectiveCamera(100, w / h, 0.001, 100),
...
var geometry = new THREE.PlaneGeometry(200, 200, 10);
...
// chassisBody.addShape(new CANNON.Box(new CANNON.Vec3(1, 1, 2)));
// chassisBody.addShape(chassisShape);
...
scene.add(wall.cube);
world.addBody(wall.boxBody);
wall.boxBody.position.set(10, 0, 0);
wall.cube.position.set(10, 0, 0);
...
function navigate(e) {
	...
	switch (e.keyCode) {
		case 38: // forward
			...
			// vehicle.setBrake(keyup ? 1 : 3, 0);
			// vehicle.setBrake(keyup ? 1 : 3, 1);
			// vehicle.setBrake(keyup ? 1 : 3, 2);
			// vehicle.setBrake(keyup ? 1 : 3, 3);
			break;
